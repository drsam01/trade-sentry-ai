# File: drlfusion/modelling/agents/agent_managers/dqn_manager.py
...
class DQNManager(BaseManager):
    ...
    def __init__(
        ...
        self.optimizer = torch.optim.Adam(self.agent.q_net.parameters(), lr=self.agent.learning_rate)
    ...
    def update(self, _: Dict = None) -> Dict[str, float]:
        """
