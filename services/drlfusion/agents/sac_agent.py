# File: drlfusion/modelling/agents/agent_architectures/sac_agent.py
...
class SACAgent(BaseAgent):
    ...
    def choose_action(
        ...
        dist = torch.distributions.Normal(mean, std)  # Always define dist
        ...
        if deterministic:
            ...
            action_tensor = torch.tanh(sampled_action)
